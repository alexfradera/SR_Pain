...
The Tudge walkthrough doesn't discuss this. But it seems that we have  information from the keywords that hasn't been reduced down in the network analysis, but we don't want to discard either.
```{r longlist}
...
```{r}
grouped_terms <-list(
  pain=longlist[c(12,13,14,37,44,45,50,54,55,62,63)],
 cognition=longlist[c(15:20,24,51,96yes)],
  screen=longlist[c(7,82,93)]
)
