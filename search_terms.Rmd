...
```{r network_cutoffs}
S1_cutoff<- find_network_cutoffs(S1_net_strengths, S1_network)
...
```{r}
S1_net_redux <- reduce_graph(S1_network, cutoff_change[1]) # tweak this number to change the cutoff option
